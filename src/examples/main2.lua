...
player = Player:new{x=0,y=0,sprite="MONSTER_001"}
monster = Monster:new{x=0,y=0,sprite="MONSTER_002"}
--sceneChange = false
playerMoving = false
playerMoveToX = 0
playerMoveToY = 0
...
function love.load()
  ...
  graphics.init()
  area = map.create(32,32,map.themes.cave)
...
function love.keypressed(key)
  ...
  print(area:getThing(player.x, player.y))
